...
apt-get install build-essential libacl1-dev libattr1-dev libgnutls-dev bind9 libreadline-dev python-dev rpl libpython2.6 krb5-user libdm0 acl attr libacl1-dev libblkid-dev gdb pkg-config libpopt-dev libldap2-dev dnsutils libbsd-dev attr
