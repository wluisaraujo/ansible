...
echo -en "$AZUL-> Popular o /var/cache/apt/archives para evitar Download$END"
read
...
apt-get install rpl bind9 ntp libpython2.6 krb5-user libdm0 acl cups attr
...
echo -en "$AZUL-> Instalar o Pacote do Samba 4$END"
read
...
cd /srv
rm -rf /srv/*
mkdir setores publico profiles
chmod 777 publico profiles
mv /etc/init.d/sernet-samba4 /etc/init.d/samba4
