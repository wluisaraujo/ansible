...
vboxmanage hostonlyif ipconfig vboxnet0 --ip 200.100.50.254 --netmask 255.255.255.0
...
vboxmanage hostonlyif create
vboxmanage hostonlyif ipconfig vboxnet1 --ip 172.16.100.254 --netmask 255.255.255.0 
